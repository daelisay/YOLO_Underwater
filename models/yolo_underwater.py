...
class YOLO_Underwater(nn.Module):
    def __init__(self, num_classes, image_size, use_preprocessing=False):
        ...
        self.pep6 = GhostBottleneck(128, 192, 128, se_ratio=0.25, ghost_ratio=2)

        self.ep3 = GhostBottleneck(128, 384, 128, se_ratio=0, ghost_ratio=2, stride=2)
        self.pep9 = GhostBottleneck(128, 512, 128, se_ratio=0.25, ghost_ratio=2)
        self.pep12 = GhostBottleneck(128, 768, 128, se_ratio=0, ghost_ratio=2)
        ...
        self.pep17 = GhostBottleneck(128, 1024, 128, se_ratio=0.25, ghost_ratio=2)
        self.conv5 = GhostBottleneck(128, 1024, 128, se_ratio=0, ghost_ratio=2)
        self.chp_op2 = CheapOps(128, 128)
        self.mix2 = Mix(inp=256, oup=128)

        self.conv6 = conv1x1(256, 128, stride=1)
        self.pep19 = GhostBottleneck(384, 768, 256, se_ratio=0, ghost_ratio=2)
        self.conv7 = conv1x1(256, 128, stride=1)
        self.conv8 = conv1x1(128, 64, stride=1)
        self.pep20 = GhostBottleneck(192, 512, 128, se_ratio=0, ghost_ratio=2)
    ...
    def forward(self, x, targets=None, indexes=None):
        ...
        out_conv9_cls = torch.sigmoid(self.conv9_cls(out_cls))
        ...
        out_conv10_cls = torch.sigmoid(self.conv10_cls(out_cls))
        ...
        out_conv11_cls = torch.sigmoid(self.conv11_cls(out_cls))
